...
public enum ErrorType {
    ...
    CONTRACT_NOT_AGREED(HttpStatus.CONFLICT, "채무자 서명이 완료된 계약이 아닙니다."),
    ...
    // RepaymentSchedule 관련
    REPAYMENT_SCHEDULE_NOT_FOUND(HttpStatus.NOT_FOUND, "상환 일정을 찾을 수 없습니다."),
    VIRTUAL_ACCOUNT_ALREADY_ISSUED(HttpStatus.CONFLICT, "이미 가상계좌가 발급된 계약입니다."),

    // 외부 API 관련
    TOSS_PAYMENTS_ERROR(HttpStatus.BAD_GATEWAY, "토스페이먼츠 API 호출에 실패했습니다.");
